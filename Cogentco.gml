graph [
  ...
  Network "Cogent "
  Provenance "Primary"
  Note "Contains Aleron"
  Source "http://www.cogentco.com/us/network_map.php"
  Version "1.0"
  DateType "Current"
  Type "COM"
  Backbone 1
  ...
  node [
    ...
    Internal 1
    Latitude 45.74944
    type "On-Net and Off-Net Market"
  ]
  node [
    id 1
    label "Bucharest"
  ...
  node [
    ...
    Internal 1
    Latitude 43.0389
    type "On-Net and Off-Net Market with Cogent Data Center(s)"
  ]
  node [
    id 11
    label "Minneapolis"
